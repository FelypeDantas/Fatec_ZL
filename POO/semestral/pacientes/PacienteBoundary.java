...
public class PacienteBoundary extends Application {
    ...
    public void vincularPropriedes() { 
        ...
        Bindings.bindBidirectional(txtEndereco.valueProperty(), control.enderecoProperty());
        Bindings.bindBidirectional(txtCartaoSus.valueProperty(), control.cartaoSusProperty());
    }
